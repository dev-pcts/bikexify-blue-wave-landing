      ...
      {isMenuOpen && (
        <div className="md:hidden absolute top-full left-0 right-0 bg-white shadow-md animate-fade-in">
          <ul className="flex flex-col py-4">
            <li><a href="#bikes" className="block py-2 px-4 text-gray-700 hover:bg-oceanblue-50 hover:text-oceanblue-500" onClick={() => setIsMenuOpen(false)}>Bikes</a></li>
            <li><a href="#how-it-works" className="block py-2 px-4 text-gray-700 hover:bg-oceanblue-50 hover:text-oceanblue-500" onClick={() => setIsMenuOpen(false)}>How It Works</a></li>
            <li><a href="#pricing" className="block py-2 px-4 text-gray-700 hover:bg-oceanblue-50 hover:text-oceanblue-500" onClick={() => setIsMenuOpen(false)}>Pricing</a></li>
            <li><a href="#locations" className="block py-2 px-4 text-gray-700 hover:bg-oceanblue-50 hover:text-oceanblue-500" onClick={() => setIsMenuOpen(false)}>Locations</a></li>
